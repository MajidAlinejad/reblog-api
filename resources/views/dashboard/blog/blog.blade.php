...
@section('content')
    ...
    <div class="grid grid-cols-12 pb-4 mb-8 border-b-2">
        ...
        <div class="col-span-10 sm:col-span-10">
            <h1 class="pl-4 text-3xl ">بلاگ</h1>
        </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 bg-gray-50">
                                    <span
                                        class="text-xs font-medium text-center text-gray-500 uppercase bg-gray-50">پست</span>
                                </th>
                            </tr>
                        </thead>
                            ...
                            @foreach ($blog as $key => $item)
                                <tr>
                                                        ...
                                                        <div class="sm:flex sm:items-start">
                                                            ...
                                                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-right">
                                                                <h3 class="text-lg font-medium leading-6 text-gray-900"
                                                                    id="modal-headline">
                                                                    حذف بلاگ با آدرس {{ $item->url }}/
                                                                </h3>
                                                                <div class="mt-2">
                                                                    <p class="text-sm text-gray-500">
                                                                        آیا مطمئن هستید؟ اگر یک بلاگ حذف شود تمامی موارد
                                    ...
                                    <td class="px-2 py-4 text-center whitespace-nowrap">
                                        <a href="/posts/{{ $item->id }}" class="text-cool-gray-500">
