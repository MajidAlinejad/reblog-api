                        ...
                        <div class="grid">
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                ...
                                <div class="grid grid-cols-8 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-2">
                                        <label for="view" class="block text-sm font-medium text-right text-gray-700">حالت
                                            نمایش</label>
                                    ...
                                    <div class="col-span-6 sm:col-span-2">
                                        ...
                                        <select id="base" name="base"
                                            ...
                                            @if ($blog->base === 'img')
                                                ...
                                                <option value="product">فروشگاه</option>
                                            ...
                                            @if ($blog->base === 'product')
                                                ...
                                                <option value="post">پست</option>
                                                <option value="music">موزیک</option>
                                                <option value="product" selected>فروشگاه</option>
                                            @endif
                                        </select>
                                    </div>

                                    <div class="col-span-6 sm:col-span-2">
                                        <label for="toolbar" class="block text-sm font-medium text-right text-gray-700">نوار
                                            بالایی</label>
                                        <select id="toolbar" name="toolbar"
                                            class="block w-full px-3 py-2 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ">
                                            @if ($blog->toolbar === 'search')
                                                <option value="search" selected>جستجو</option>
                                    ...
                                    <div class="col-span-6 sm:col-span-2">
                                        <label for="loader" class="block text-sm font-medium text-right text-gray-700">لودر
                                        </label>
                                ...
                                <div class="grid grid-cols-8 gap-6 mt-6">
                                    <div class="col-span-6 sm:col-span-2">
                                        <label for="icon"
                                            ...
                                            icon</label>
                                        <input placeholder="svg-d code" value="{{ $blog->icon }}" name="icon" type="text"
                                            id="icon"
                                            class="block w-full px-3 py-2 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ">
                                    </div>
                                    <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <div class="col-span-6 sm:col-span-2">
                                        <label for="first_name"
                                            ...
                                            url</label>
                                        <input placeholder="url" value="{{ $blog->url }}" name="url" type="text"
                                            id="first_name"
                                            class="block w-full px-3 py-2 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ">
                                    </div>
                                    <div class="col-span-6 sm:col-span-2">
                                        ...
                                        <input placeholder="meta" value="{{ $blog->meta }}" name="meta" type="text"
                                            id="meta"
                                            class="block w-full px-3 py-2 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ">
                                    </div>
