...
<div class="flex flex-col">
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="px-2 py-3 bg-gray-50">
                                <span class="sr-only">ارتباظ</span>
                            </th>
                            <th scope="col" class="px-2 py-3 bg-gray-50">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="text-sm font-medium text-right whitespace-nowrap">
                                <a href="/brand/{{$item->id}}" class="text-indigo-600 hover:text-indigo-900">ویرایش</a>
                            </td>
                            <td x-data="{wire{{$item->id}}:false}" class="">
                                <button @click="wire{{$item->id}} = true"
                                    class="text-sm text-blue-600 hover:text-blue-900"">ارتباط</button>
                                    <div x-show=" wire{{$item->id}}" class="fixed inset-0 z-10 overflow-y-auto">
                                    <div
                                        ...
                                        <div class="inline-block w-2/3 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl modal-anim sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full "
                                            ...
                                            <form method="POST" enctype="multipart/form-data"
                                                ...
                                                <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                                                    <div
                                                        class="inline-flex w-full pb-3 align-middle border-b-2 border-blue-100 border-dashed ">
                                                        <div
                                                    ...
                                                    <div class="grid grid-cols-6 gap-6 m-3 text-center">
                                                        @csrf
                                                        @foreach ($category as $cat)
                                                        <div class="col-span-2 text-center">
                                                            <label class="inline-flex items-center">
                                                            <input name="cats[]" value="{{$cat->id}}" type="checkbox" class="form-checkbox" 
                                                            @foreach ($item->categories as $pivot)
                                                                @if ($pivot->id === $cat->id )
                                                                checked
                                                                @endif
                                                            @endforeach
                                                ...
                                                <div class="px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
                                                    ...
                                                    <button type="button" @click="wire{{$item->id}} = false"
                                                        class="inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                                                        لغو
                                                    </button>
                                                </div>
            ...
            <td x-data="{var{{$item->id}}:false}" class="px-1 py-4 text-sm font-medium text-right whitespace-nowrap">
                <button @click="var{{$item->id}} = true" class="text-red-600 hover:text-indigo-900">حذف</button>
                                    ...
                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-right">
                                        ...
                                        <div class="mt-2">
                                            <p class="text-sm text-gray-500">
                                                آیا مطمئن هستید؟
                                                ممکن است پست هایی با این برند در ارتباط باشند.قبل از حذف برند از این
                                                مورد مطمئن شوید.
                                            </p>
                                        </div>
                                    </div>
