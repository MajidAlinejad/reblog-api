...
<div class="grid grid-cols-12 pb-4 mb-8 border-b-2">
    ...
    <div class="col-span-10 sm:col-span-10">
        <h1 class="pl-4 text-3xl "> ویرایش برند </h1>
    </div>
...
<div class="flex flex-col">
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
            ...
            <form method="POST" enctype="multipart/form-data" action="/brand/{{$brand->id}}">
                    {{ method_field('PUT') }}
                    <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                        <div
                            ...
                            <div
                                ...
                                <img class="w-10 h-10 rounded-full" src="<?php echo asset("$brand->img")?>"
                                alt="">
                            </div>
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-2">
                                        <label for="first_name"
                                            ...
                                            نام انگلیسی</label>
                                    <input placeholder="  نام انگلیسی" value="{{$brand->name}}" name="name" type="text" id="first_name"
                                    ...
                                    <div class="col-span-6 sm:col-span-2">
                                        <label for="first_name"
                                            class="block text-sm font-medium text-right text-gray-700">
                                            نام فارسی</label>
                                    <input placeholder="نام فارسی" value="{{$brand->fa_name}}" name="fa_name" type="text" id="first_name"
                                            class="block w-full px-3 py-2 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ">
                                    </div>
                                    ...
                                    <div class="col-span-6 sm:col-span-2">
                                        <div>
                                          ...
                                          <img class="w-10 h-10 mx-2 border border-gray-300 rounded-full" src="<?php echo asset("$brand->img")?>"
                                            alt="">
                                            </div>
                                          </div>
                                    ...
                                    <div class="col-span-6 sm:col-span-6">
                                        <label for="first_name"
                                            class="block text-sm font-medium text-right text-gray-700">
                                            توضیح مختصر</label>
                                    <input placeholder=" توضیح مختصر" value="{{$brand->desc}}" name="desc" type="text" id="first_name"
                                            class="block w-full px-3 py-2 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm ">
                                    </div>
                                </div>
                            </div>
