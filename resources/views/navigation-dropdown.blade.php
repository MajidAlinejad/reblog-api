<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <div onclick="sideTg()" class="flex items-center flex-shrink-0 p-4 cursor-pointer hover:text-teal-500">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:mr-10 sm:ml-10 sm:flex">
            ...
            <div class="flex items-center -mr-2 sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 text-gray-400 transition duration-150 ease-in-out rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500">
                    <span :class="{'hidden': open, 'inline-flex': ! open }"><ion-icon size="large" name="person-circle-outline"></ion-icon></span>
                    <span :class="{'hidden': ! open, 'inline-flex': open }"><ion-icon size="large" name="close-outline"></ion-icon></span>
                </button>
            </div>
        </div>
    </div>
